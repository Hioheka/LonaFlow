        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RecurringTransactions_Creditors_CreditorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecurringTransactionInstances_RecurringTransactions_RecurringTransactionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentMethodId = table.Column<int>(type: "int", nullable: true),
                    CreditorId = table.Column<int>(type: "int", nullable: true),
                    RecurringTransactionInstanceId = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Transactions_Creditors_CreditorId",
                        column: x => x.CreditorId,
                        principalTable: "Creditors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Transactions_RecurringTransactionInstances_RecurringTransactionInstanceId",
                        column: x => x.RecurringTransactionInstanceId,
                        principalTable: "RecurringTransactionInstances",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecurringTransactionInstances_DueDate",
                table: "RecurringTransactionInstances",
                column: "DueDate");

            migrationBuilder.CreateIndex(
                name: "IX_RecurringTransactionInstances_IsProcessed",
                table: "RecurringTransactionInstances",
                column: "IsProcessed");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecurringTransactions_CreditorId",
                table: "RecurringTransactions",
                column: "CreditorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_RecurringTransactionInstanceId",
                table: "Transactions",
                column: "RecurringTransactionInstanceId",
                unique: true,
                filter: "[RecurringTransactionInstanceId] IS NOT NULL");
